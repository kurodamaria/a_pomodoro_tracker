...
abstract class _$PomoDatabase extends GeneratedDatabase {
  _$PomoDatabase(QueryExecutor e) : super(SqlTypeSystem.defaultInstance, e);
  late final $TasksTable tasks = $TasksTable(this);
  late final $FinishedTasksTable finishedTasks = $FinishedTasksTable(this);
  @override
  Iterable<TableInfo> get allTables => allSchemaEntities.whereType<TableInfo>();
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [tasks, finishedTasks];
}
